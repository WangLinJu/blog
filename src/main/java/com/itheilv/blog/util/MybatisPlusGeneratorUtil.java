...
public class MybatisPlusGeneratorUtil {
    ...
    public static void generator(String likeTable, String packageName, String module, String jdbcDriver, String jdbcUrl, String jdbcUsername, String jdbcPassword) {
        ...
        // 自定义 mapper 父类
        strategy.setSuperMapperClass("com.itheilv.blog.base.BaseMapper");
        // 自定义 service 父类
        strategy.setSuperServiceClass("com.itheilv.blog.base.BaseService");
        // 自定义 service 实现类父类
        strategy.setSuperServiceImplClass("com.itheilv.blog.base.BaseServiceImpl");
        // 自定义 controller 父类
        strategy.setSuperControllerClass("com.itheilv.blog.base.BaseController");
